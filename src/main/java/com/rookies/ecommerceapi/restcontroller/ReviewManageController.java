...
public class ReviewManageController {
        ...
        @Autowired
        public ReviewManageController(ReviewService reviewService, JwtUtils jwtUtils, ReviewConverter reviewConverter) {
        ...
        public ResponseEntity<ResponseDto> saveReview(HttpServletRequest req, @Valid @RequestBody ReviewDto reviewDto) {
                ...
                responseDto.setData(reviewConverter.convertToDto((Review) responseDto.getData()));
        ...
        @PutMapping
        @PreAuthorize("hasRole('ROLE_CUSTOMER')")
        public ResponseEntity<ResponseDto> updateReview(HttpServletRequest req,
        ...
        @PreAuthorize("hasRole('ROLE_CUSTOMER')")
        public ResponseEntity<ResponseDto> deleteReview(HttpServletRequest req,
