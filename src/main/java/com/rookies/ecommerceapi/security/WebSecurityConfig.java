package com.rookies.ecommerceapi.security;
...
import com.rookies.ecommerceapi.security.jwt.JwtAuthEntryPoint;
import com.rookies.ecommerceapi.security.jwt.JwtAuthTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/api/v1/empployee/auth/**").permitAll()
